      ...
      <div className="w-full max-w-sm space-y-8 my-auto py-8">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-4 bg-slate-800 text-white font-black text-sm rounded-xl shadow-lg active:scale-[0.98] transition-transform flex items-center justify-center mt-6"
          >
        ...
        <button
          type="button" onClick={handleGoogleRegister} disabled={isSubmitting}
          className="w-full py-3.5 bg-white border border-slate-200 text-slate-700 font-bold text-sm rounded-xl shadow-sm hover:bg-slate-50 active:scale-[0.98] transition-transform flex items-center justify-center gap-3"
        >
        ...
        <p className="text-center text-xs font-bold text-slate-500">
          Sudah terdaftar?{' '}
          <button onClick={onSwitch} className="text-emerald-600 hover:underline">Masuk di sini</button>
        </p>
      </div>
    </div>
  );
